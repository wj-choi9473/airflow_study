"""
Airflow meta DB를 조회하여 Daily task 성공,실패,미수행, 수행중 조회 예시

1. 쿼리 작성 files/sqls/daily_dag_monitoring.sql
2. MetaDB Connection 등록
3. slack block 구조 이해 및 config작성 plugins/config/slack_block_builder.py
4. DAG 작성
"""
